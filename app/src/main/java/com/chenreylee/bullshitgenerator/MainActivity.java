    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String content = 生成文章(edtTheme.getText().toString(), 需要的文章长度);
...
//    public static String 主题 = "666";
    ...
    public static int 需要的文章长度 = 4000;

    public static String[] 论述 = {
    ...
    public static String 来点论述(String 主题) {
        String 句子 = 随便取一句(论述);
    ...
    public static String 生成文章(String 主题, Integer 需要的文章长度) {
